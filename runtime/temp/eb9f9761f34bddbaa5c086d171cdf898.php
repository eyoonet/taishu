<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:74:"D:\phpStudy\WWW\taishu\public/../application/admin\view\project\index.html";i:1472792902;s:67:"D:\phpStudy\WWW\taishu\public/../application/admin\view\layout.html";i:1472719816;s:72:"D:\phpStudy\WWW\taishu\public/../application/admin\view\public\head.html";i:1472719816;s:74:"D:\phpStudy\WWW\taishu\public/../application/admin\view\public\header.html";i:1472719816;s:75:"D:\phpStudy\WWW\taishu\public/../application/admin\view\public\sidebar.html";i:1472719816;s:74:"D:\phpStudy\WWW\taishu\public/../application/admin\view\public\script.html";i:1472719816;}*/ ?>
<!doctype html>
  ...
  <div class="admin-content">
    <div class="admin-content-body">
	  ...
	  <div class="am-cf am-padding">
         <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">后台管理</strong> / <small>默认项目设置</small></div>
      </div>

      
<div class="am-container">
	<a href="<?php echo url('/admin/project/add'); ?>" class="am-btn am-btn-primary am-btn-xs">添 加</a>
		    ...
		    <tbody id='project'>
		       <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
		        <tr class="">
		            ...
		            <td>
                      <a href="<?php echo url('/admin/project/edit'); ?>?id=<?php echo $value['id']; ?>">编辑</a> | 
                      <a href="<?php echo url('/admin/project/del'); ?>?id=<?php echo $value['id']; ?>">删除</a>
		           </td>		            
		        </tr>
		       <?php endforeach; endif; else: echo "" ;endif; ?>      
		    </tbody>
