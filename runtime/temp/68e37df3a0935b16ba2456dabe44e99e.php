  ...
  <div class="admin-content">
    <div class="admin-content-body">
	  ...
	  <div class="am-cf am-padding">
         <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">后台管理</strong> / <small>楼列表</small></div>
      </div>
		        ...
		        <tr class="">
		            ...
		            <td>
		             <div class="am-dropdown" data-am-dropdown>
	                  ...
	                  <ul class="am-dropdown-content">
                        <li><a href="<?php echo url('admin/room/add'); ?>?id=<?php echo $value['id']; ?>">1. 添加房间</a></li>
                        <li><a href="<?php echo url('/admin/room'); ?>?fid=<?php echo $value['id']; ?>">2. 查看房间</a></li>
	                    <li><a href="<?php echo url('admin/floor/edit'); ?>?id=<?php echo $value['id']; ?>">3. 编辑</a></li>
	                    <li><a href="<?php echo url('admin/floor/del'); ?>?id=<?php echo $value['id']; ?>">4. 删除</a></li>
	                  </ul>
                    </div>
		           </td>		            
		        </tr>
