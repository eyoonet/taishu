  ...
  <div class="admin-content">
    <div class="admin-content-body">
	  ...
	  <div class="am-cf am-padding">
         <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">后台管理</strong> / <small>房间列表</small></div>
      </div>
		    ...
		    <tbody>
		       <?php if(is_array($list) || $list instanceof \think\Collection): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
		        <tr class="">
		            ...
		            <td><?php echo $value['shui_number']; ?></td>
		            <td><?php echo $value['dian_number']; ?></td>
		            <td><?php echo $value['price']; ?></td>
		            <td><?php echo $value['equipment']; ?></td>
		            <td>
		             <div class="am-dropdown" data-am-dropdown>
	                  <button class="am-btn am-btn-default am-btn-xs am-dropdown-toggle" data-am-dropdown-toggle><span class="am-icon-cog"></span> <span class="am-icon-caret-down"></span></button>
	                  <ul class="am-dropdown-content">
	                    <li><a href="<?php echo url('admin/room/edit'); ?>?id=<?php echo $value['id']; ?>">1. 编辑</a></li>
	                    <li><a href="<?php echo url('admin/room/del'); ?>?id=<?php echo $value['id']; ?>">2. 删除</a></li>
	                  </ul>
                    </div>
		           </td>		            
		        </tr>
